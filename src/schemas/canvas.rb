$schema = {
  ...
  live_assignment_override_created: {
    # created
    assignment_override_created_id: { type: 'bigint', primary_key: true },
    processed_at: { type: 'datetime' },
    event_time_local: { type: 'datetime' },
    # metadata
    client_ip: { type: 'string', size: 39 },
    ...
    due_at: { type: 'datetime' },
    all_day: { type: 'string', size: 6 },
    all_day_date: { type: 'datetime' },
    unlock_at: { type: 'datetime' },
    lock_at: { type: 'datetime' },
  ...
  live_assignment_override_updated: {
    # created
    assignment_override_updated_id: { type: 'bigint', primary_key: true },
    processed_at: { type: 'datetime' },
    event_time_local: { type: 'datetime' },
    # metadata
    client_ip: { type: 'string', size: 39 },
  ...
  live_conversation_created: {
    # created
    conversation_created_id: { type: 'bigint', primary_key: true },
    processed_at: { type: 'datetime' },
    event_time_local: { type: 'datetime' },
    # metadata
    client_ip: { type: 'string', size: 39 },
  ...
  live_conversation_message_created: {
    # created
    conversation_message_created_id: { type: 'bigint', primary_key: true },
    processed_at: { type: 'datetime' },
    event_time_local: { type: 'datetime' },
    # metadata
    client_ip: { type: 'string', size: 39 },
  ...
  live_course_grade_change: {
    # created
    course_grade_change_id: { type: 'bigint', primary_key: true },
    processed_at: { type: 'datetime' },
    event_time_local: { type: 'datetime' },
    # metadata
    # client_ip: { type: 'string', size: 39 },
    ...
    created_at: { type: 'datetime' },
    updated_at: { type: 'datetime' },
    current_score: { type: 'float', size: 53 },
    old_current_score: { type: 'float', size: 53 },
    final_score: { type: 'float', size: 53 },
    old_final_score: { type: 'float', size: 53 },
    unposted_current_score: { type: 'float', size: 53 },
    old_unposted_current_score: { type: 'float', size: 53 },
    unposted_final_score: { type: 'float', size: 53 },
    old_unposted_final_score: { type: 'float', size: 53 },
  },
  ...
  live_grade_change: {
    ...
    old_grade: { type: 'string', size: 255 },
  ...
  live_learning_outcome_created: {
    # created
    learning_outcome_created_id: { type: 'bigint', primary_key: true },
    processed_at: { type: 'datetime' },
    event_time_local: { type: 'datetime' },
    # metadata
    client_ip: { type: 'string', size: 39 },
    ...
    context_id: { type: 'bigint' },
    context_type: { type: 'string', size: 24 },
    display_name: { type: 'string', size: 255 },
    short_description: { type: 'string', size: 255 },
    description: { type: 'string', size: 'MAX', mbstr: true },
  ...
  live_learning_outcome_group_created: {
    # created
    learning_outcome_group_created_id: { type: 'bigint', primary_key: true },
    processed_at: { type: 'datetime' },
    event_time_local: { type: 'datetime' },
    # metadata
    client_ip: { type: 'string', size: 39 },
  ...
  live_learning_outcome_group_updated: {
    # created
    learning_outcome_group_updated_id: { type: 'bigint', primary_key: true },
    processed_at: { type: 'datetime' },
    event_time_local: { type: 'datetime' },
    # metadata
    client_ip: { type: 'string', size: 39 },
  ...
  live_learning_outcome_link_created: {
    # created
    learning_outcome_link_created_id: { type: 'bigint', primary_key: true },
    processed_at: { type: 'datetime' },
    event_time_local: { type: 'datetime' },
    # metadata
    client_ip: { type: 'string', size: 39 },
  ...
  live_learning_outcome_updated: {
    # created
    learning_outcome_updated_id: { type: 'bigint', primary_key: true },
    processed_at: { type: 'datetime' },
    event_time_local: { type: 'datetime' },
    # metadata
    client_ip: { type: 'string', size: 39 },
  ...
  live_plagiarism_resubmit: {
    ...
    late: { type: 'string', size: 5 },
    missing: { type: 'string', size: 5 },
  },
  ...
  live_quizzes_next_quiz_duplicated: {
    ...
    new_course_resource_link_id: { type: 'string', size: 40 },
  ...
  live_quizzes_quiz_session_submitted: {
    ...
    graded_url: { type: 'string', size: 78 },
    id: { type: 'int' },
  ...
  live_quiz_caliper_asset_accessed: {
    # created
    quiz_caliper_asset_accessed_id: { type: 'bigint', primary_key: true },
    processed_at: { type: 'datetime' },
    event_time_local: { type: 'datetime' },
    # metadata
    client_ip: { type: 'string', size: 39 },
  ...
  live_quiz_caliper_quiz_session_created: {
    # created
    quiz_caliper_quiz_session_created_id: { type: 'bigint', primary_key: true },
    processed_at: { type: 'datetime' },
    event_time_local: { type: 'datetime' },
    # metadata
    client_ip: { type: 'string', size: 39 },
    event_name: { type: 'string', size: 33 },
    event_time: { type: 'datetime' },
    hostname: { type: 'string', size: 64 },
    http_method: { type: 'string', size: 7 },
    producer: { type: 'string', size: 12 },
    ...
    id: { type: 'int' },
    start_at: { type: 'datetime' },
    status: { type: 'string', size: 12 },
    submitted_at: { type: 'datetime' },
  },

  live_quiz_caliper_quiz_session_updated: {
    # created
    quiz_caliper_quiz_session_updated_id: { type: 'bigint', primary_key: true },
    processed_at: { type: 'datetime' },
    event_time_local: { type: 'datetime' },
    # metadata
    client_ip: { type: 'string', size: 39 },
    ...
    id: { type: 'int' },
    start_at: { type: 'datetime' },
    status: { type: 'string', size: 22 },
    submitted_at: { type: 'datetime' },
  },

  live_quiz_caliper_quiz_created: {
    # created
    quiz_caliper_quiz_created_id: { type: 'bigint', primary_key: true },
    processed_at: { type: 'datetime' },
    event_time_local: { type: 'datetime' },
    # metadata
    client_ip: { type: 'string', size: 39 },
  ...
  live_quiz_caliper_quiz_started: {
    # created
    quiz_caliper_quiz_started_id: { type: 'bigint', primary_key: true },
    processed_at: { type: 'datetime' },
    event_time_local: { type: 'datetime' },
    # metadata
    client_ip: { type: 'string', size: 39 },
  ...
  live_quiz_caliper_quiz_submitted: {
    # created
    quiz_caliper_quiz_submitted_id: { type: 'bigint', primary_key: true },
    processed_at: { type: 'datetime' },
    event_time_local: { type: 'datetime' },
    # metadata
    client_ip: { type: 'string', size: 39 },
  ...
  live_quiz_caliper_quiz_updated: {
    # created
    quiz_caliper_quiz_updated_id: { type: 'bigint', primary_key: true },
    processed_at: { type: 'datetime' },
    event_time_local: { type: 'datetime' },
    # metadata
    client_ip: { type: 'string', size: 39 },
  ...
  live_quiz_caliper_item_created: {
    # created
    quiz_caliper_item_created_id: { type: 'bigint', primary_key: true },
    processed_at: { type: 'datetime' },
    event_time_local: { type: 'datetime' },
    # metadata
    client_ip: { type: 'string', size: 39 },
  ...
  live_quiz_caliper_item_updated: {
    # created
    quiz_caliper_item_updated_id: { type: 'bigint', primary_key: true },
    processed_at: { type: 'datetime' },
    event_time_local: { type: 'datetime' },
    # metadata
    client_ip: { type: 'string', size: 39 },
  ...
  live_sis_batch_created: {
    sis_batch_created_id: { type: 'bigint', primary_key: true },
    processed_at: { type: 'datetime' },
    event_time_local: { type: 'datetime' },
    # metadata
    client_ip: { type: 'string', size: 39 },
  ...
  live_sis_batch_updated: {
    sis_batch_updated_id: { type: 'bigint', primary_key: true },
    processed_at: { type: 'datetime' },
    event_time_local: { type: 'datetime' },
    # metadata
    client_ip: { type: 'string', size: 39 },
    ...
    sis_batch_id: { type: 'string', size: 32 },
    account_id: { type: 'int' },
    workflow_state: { type: 'string', size: 22 },
  },
