module LiveStream
  ...
  def live_stream(event_name, event_time, event_data)
    ...
    data = {
      ...
      user_id_body:           body['user_id'].nil? ? nil : body['user_id'].to_i,
      ...
      context_id_body:        body['context_id'].nil? ? nil : body['context_id'].to_i,
      context_id_meta:        meta['context_id'].nil? ? nil : meta['context_id'].to_i,
      context_role_body:      body['context_role'].nil? ? nil : body['context_role'].to_s,
      context_role_meta:      meta['context_role'].nil? ? nil : meta['context_role'].to_s,
      context_type_body:      body['context_type'].nil? ? nil : body['context_type'].to_s,
      ...
      asset_category:         body['category'].nil? ? nil : body['category'].to_s,
      asset_role:             body['role'].nil? ? nil : body['role'].to_s,
      asset_level:            body['level'].nil? ? nil : body['level'].to_s,
      # submissions
