$schema = {
  ...
  live_attachment_created: {
    ...
    user_id: { type: 'bigint' },
    display_name: { type: 'string', size: 'MAX' },
    filename: { type: 'string', size: 'MAX' },
  ...
  live_attachment_deleted: {
    ...
    attachment_id: { type: 'bigint' },
    user_id: { type: 'bigint' },
    display_name: { type: 'string', size: 255, mbstr: true },
    folder_id: { type: 'bigint' },
    filename: { type: 'string', size: 255, mbstr: true },
  ...
  live_attachment_updated: {
    ...
    user_id: { type: 'bigint' },
    display_name: { type: 'string', size: 255, mbstr: true },
    old_display_name: { type: 'string', size: 255 },
    folder_id: { type: 'bigint' },
    filename: { type: 'string', size: 255, mbstr: true },
    context_type: { type: 'string', size: 255 },
    context_id: { type: 'bigint' },
  ...
  live_course_section_created: {
    ...
    stuck_sis_fields: { type: 'string', size: 14 },
  ...
  live_user_created: {
    ...
    user_id: { type: 'bigint' },
    uuid: { type: 'string', size: 40 },
    name: { type: 'string', size: 64, mbstr: true },
